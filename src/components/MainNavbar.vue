    ...
    <div class="container mx-auto py-2 md:flex md:justify-between md:items-center">
      ...
      >
        <div class="flex flex-col md:flex-row md:mx-2 uniquefont text-lg">
          <a
            class="my-2 text-gray-700 transition-all duration-300 transform dark:text-gray-200 hover:text-green-800 hover:text-xl dark:hover:text-green-700 md:mx-4 md:my-0"
            href="#background"
          >
            {{ $t('background') }}
          </a>
        ...
        <div class="relative">
          ...
          <div
            v-show="langIsOpen"
            class="absolute bg-white dark:bg-gray-700 rounded-lg shadow-lg w-24 z-10 ml-6"
          >
            <ul class="py-2">
...
const languages = [
  { code: 'en', label: 'EN', flag: '/src/assets/flags/gb.png' },
  { code: 'bs', label: 'BS', flag: '/src/assets/flags/ba.png' },
  { code: 'de', label: 'DE', flag: '/src/assets/flags/de.png' },
]
